...
public class ComponentInitializer {
    ...
    private List<Object> getComponentConstructorParameters(Method method) {
        ...
        for (Class<?> parameterCLass : parameterTypes) {
            for (InitializedComponent component :
                    components) { // TODO: добавить какой-то инфраструктурный класс, который возьмет на себя хранение и
                // поиск компонентов, например, ComponentRegistry
