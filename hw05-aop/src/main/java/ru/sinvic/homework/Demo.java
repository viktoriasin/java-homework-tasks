...
import ru.sinvic.homework.proxy.IoC;
...
public class Demo {
    public static void main(String[] args) {
        ...
        TestLoggingInterface myClass =
                (TestLoggingInterface) IoC.createMyClass(new TestLoggingInterfaceImpl(), TestLoggingInterface.class);
        TestInterface myClass2 = (TestInterface) IoC.createMyClass(new TestInterfaceImpl(), TestInterface.class);
